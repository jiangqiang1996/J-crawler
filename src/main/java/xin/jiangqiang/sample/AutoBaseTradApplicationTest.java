...
public class AutoBaseTradApplicationTest extends TradApplication {
    ...
    public static void main(String[] args) {
        ...
        autoBaseApplicationTest.getConfig().addRegEx("https://.*");//满足正则表达式的所有URL将会自动提取到deal生命周期的page对象
        ...
        autoBaseApplicationTest.addSeed("https://blog.jiangqiang.xin").setType("home").setLines(lines).setHeaders(headers)
